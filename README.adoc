...
pkg: gitlab.com/jhinrichsen/adventofcode2024
cpu: AMD Ryzen 7 7840HS w/ Radeon 780M Graphics
BenchmarkDay11Part1-16    	       2	2212422778 ns/op
PASS
----

That's 2.21 seconds for part 1 with 25 blinks. The exponential stone growth dominates performance - the optimized branchless digit counting and zero-allocation parser contribute negligibly to the total runtime.
