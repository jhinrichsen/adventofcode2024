...
pkg: gitlab.com/jhinrichsen/adventofcode2024
cpu: AMD Ryzen 7 7840HS w/ Radeon 780M Graphics     
BenchmarkDay07Part1-16               235           4981418 ns/op               0 B/op          0 allocs/op
----
...
pkg: gitlab.com/jhinrichsen/adventofcode2024
cpu: AMD Ryzen 7 7840HS w/ Radeon 780M Graphics     
BenchmarkDay07Part2-16                 3         488072524 ns/op               0 B/op          0 allocs/op
----

That's ~5ms for part 1 and ~488ms for part 2. Part 2 adds the concatenation operator (`||`) which combines digits from left and right operands (e.g., `12 || 345 = 12345`). The iterative solution systematically tests all operator combinations: 2^n for part 1 (+, *) and 3^n for part 2 (+, *, ||).
